...
@Component({
    selector: 'ls-form-207',
    templateUrl: '/owcs/app/components/cases/ls-forms/ls-form-207.component.html',
    styleUrls: ['/owcs/app/components/pal/pal-nav.component.css']
  })

  export class LsForm207Component implements OnInit {
        ...
        ngOnInit() {
          ...
          this.caseCreateDataForm = this.fb.group({
            ...
            placeOfInjuryCtry: '',
            stateProvidence: '',
            extentOfInjury: ['', [Validators.required]],
            ...
            claimantPhone: ['', [Validators.minLength(10), Validators.pattern(this.numeric)]],
            controversionReason: '',
            noticeDate: ''
