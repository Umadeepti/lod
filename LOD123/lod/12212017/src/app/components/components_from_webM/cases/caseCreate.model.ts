...
public controversionReason: string;
public noticeDate: string;

//208
public compDisabilityType: string;
public averageWeeklyWage: string;
public compensationRate: string;
public paymentBeginDate: string;
public paymentBeginDateReason: string;
public continuingPaySalary: string;
public inlieuCompensation: string;
public firstPaymentDate: string;
public typeOfNotice: string;
public lastPaymentDate: string;
public paymentType: string;
public paymentFromDate: string;
public paymentThroughDate: string;
public paymentWeeklyAmount: string;
public paymentWeeks: string;
public paymentPercentage: string;
public otherPaymentType: string;
public beneficiaryDescription: string;
public otherPaymentAmount: string;

//201
public stoppedWork: string;
public claimantSignatureDate: string;
public noticeDeliveryDate: string;
